...
@Component({
  selector: 'calculated-table-collapsed',
  templateUrl: './calculated-damage-collapsed.component.html'
})
export class CalculatedDamageCollapsedComponent implements OnChanges {
	@Input()
	selectedWeapon: any;
